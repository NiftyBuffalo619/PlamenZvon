...
class NewWebhookClient {
    Client = undefined;
    constructor(WebhookUrl) {
        this.WebhookUrl = WebhookUrl;
        this.Client = new WebhookClient({ url: this.WebhookUrl });
    }

    sendMessage = async (incident, FireUnitsInfo) => {
        if (Client !== undefined) {
            throw new Error("A webhook url must be specified");
        }
        try {
            //LOCATION
...
module.exports =  { NewWebhookClient };